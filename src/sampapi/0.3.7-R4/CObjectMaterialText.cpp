...
#include "sampapi/0.3.7-R4/CObjectMaterialText.h"

SAMPAPI_BEGIN_V037R4

SAMPAPI_VAR CObjectMaterialText*& RefObjectMaterialTextManager() {
    return *(CObjectMaterialText**)GetAddress(0x26EA1C);
}

CObjectMaterialText::CObjectMaterialText(IDirect3DDevice9* pDevice) {
    ((void(__thiscall*)(CObjectMaterialText*, IDirect3DDevice9*))GetAddress(0x708B0))(this, pDevice);
}

CObjectMaterialText::~CObjectMaterialText() {
    ((void(__thiscall*)(CObjectMaterialText*))GetAddress(0x708D0))(this);
}
...
void CObjectMaterialText::OnResetDevice() {
    ((void(__thiscall*)(CObjectMaterialText*))GetAddress(0x70890))(this);
}
...
IDirect3DTexture9* CObjectMaterialText::Create(const char* szText, const char* szFont, char nFontSize, int nBgSizeX, int nBgSizeY, D3DCOLOR fontColor, D3DCOLOR bgColor, bool bBold, char align) {
    return ((IDirect3DTexture9 * (__thiscall*)(CObjectMaterialText*, const char*, const char*, char, int, int, D3DCOLOR, D3DCOLOR, bool, char)) GetAddress(0x708E0))(this, szText, szFont, nFontSize, nBgSizeX, nBgSizeY, fontColor, bgColor, bBold, align);
}
