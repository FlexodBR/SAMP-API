...
#include "sampapi/0.3.7-R4/GUI.h"
...
SAMPAPI_VAR CDXUTDialog*& GUI::RefScoreboard() {
    return *(CDXUTDialog**)GetAddress(0x26EAA0);
}

SAMPAPI_VAR CDXUTDialog*& GUI::RefDialog() {
    return *(CDXUTDialog**)GetAddress(0x26EAA8);
}

SAMPAPI_VAR CDXUTDialog*& GUI::RefClassSelection() {
    return *(CDXUTDialog**)GetAddress(0x26EAA4);
}

SAMPAPI_VAR IDirect3DSurface9*& GUI::RefCursor() {
    return *(IDirect3DSurface9**)GetAddress(0x26EAB4);
}

SAMPAPI_VAR IDirect3DDevice9*& GUI::RefDevice() {
    return *(IDirect3DDevice9**)GetAddress(0x26E9B8);
}

void GUI::Initialize() {
    ((void(__cdecl*)())GetAddress(0xC5640))();
}

void GUI::OnLostDevice() {
    ((void(__cdecl*)())GetAddress(0xC3F60))();
}

void GUI::OnResetDevice() {
    ((void(__cdecl*)())GetAddress(0xC41C0))();
}

void GUI::GameUIEventHandler(unsigned int nEvent, int nControlId, CDXUTControl* pControl, void* pUserContext) {
    ((void(__stdcall*)(unsigned int, int, CDXUTControl*, void*))GetAddress(0xC5550))(nEvent, nControlId, pControl, pUserContext);
}

void GUI::ScoreboardEventHandler(unsigned int nEvent, int nControlId, CDXUTControl* pControl, void* pUserContext) {
    ((void(__stdcall*)(unsigned int, int, CDXUTControl*, void*))GetAddress(0xC5590))(nEvent, nControlId, pControl, pUserContext);
}

void GUI::DialogEventHandler(unsigned int nEvent, int nControlId, CDXUTControl* pControl, void* pUserContext) {
    ((void(__stdcall*)(unsigned int, int, CDXUTControl*, void*))GetAddress(0xC54C0))(nEvent, nControlId, pControl, pUserContext);
}

void GUI::ClassSelectionEventHandler(unsigned int nEvent, int nControlId, CDXUTControl* pControl, void* pUserContext) {
    ((void(__stdcall*)(unsigned int, int, CDXUTControl*, void*))GetAddress(0xC55C0))(nEvent, nControlId, pControl, pUserContext);
}
